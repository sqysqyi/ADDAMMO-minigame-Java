...
import static game.sqysqyi.ADDAMMOLOL.AddAmmoMain.Actions.ActionLabel.*;
import static game.sqysqyi.ADDAMMOLOL.AddAmmoMain.Actions.ActionLabel.LabelName.*;
import static game.sqysqyi.ADDAMMOLOL.AddAmmoMain.Actions.ActionLabelsContainer.*;
...
public enum ActionX{
    ...
    ADD_AMMO(
        ...
        true,
        ActionX::DO_ADD_AMMO,
        createLabelsContainer(new ActionLabel[]{L(ABSOLUTE_SAFE), L(CAN_BE_STOLEN)})
        ),
    ...
    PISTOL_SHOOT(
        ...
        createLabelsContainer(new ActionLabel[]{L(CRIMINALS,1), L(CAN_BE_STOLEN), L(MID_RANGE_ATTACKING), L(ENCOUNTER)})
        ),
    DOUBLE_SHOOT(
        202, "Double shoot", 2, 
    ...
    DEF(
        ...
        false, 
        ActionX::DO_DEF,
        createLabelsContainer(new ActionLabel[]{L(ENCOUNTER)})
        ),
    ABSLOTE_DEF(
        ...
        createLabelsContainer(new ActionLabel[]{L(AIR_RAID), L(ENCOUNTER), L(FROM_UNDERGOUND)})
        ),
    // 400 series thieives
    THIEF(
        401, "Thief", 1, 
        ...
        false, 
        ActionX::DO_THIEF,
        createLabelsContainer(new ActionLabel[]{L(CRIMINALS,1), L(THIEVES,1), L(SHORT_RANGE_ATTACKING), L(ENCOUNTER)})
        ),
    ROUGE(
        402,"Rouge",2,
        ...
        false,
        ActionX::DO_ROUGE,
        createLabelsContainer(new ActionLabel[]{L(CRIMINALS,2), L(THIEVES,2), L(MID_RANGE_ATTACKING), L(AIR_RAID)})
        ),
    //500 series polices
    POLICE(
        501,"Police",0,
        ...
        false,
        ActionX::DO_POLICE,
        createLabelsContainer(new ActionLabel[]{L(POLICES,1), L(SHORT_RANGE_ATTACKING), L(ENCOUNTER)})
        ),
    ARMED_POLICE(
        502,"Armed poilce",2,
        ...
        createLabelsContainer(new ActionLabel[]{L(POLICES,2), L(MID_RANGE_ATTACKING), L(ENCOUNTER)})
        ),
    ...
    RPG(
        ...
        true,
        ActionX::DO_RPG,
        createLabelsContainer(new ActionLabel[]{L(CRIMINALS, 3), L(CAN_BE_STOLEN), L(LONG_RANGE_ATTACKING), L(ENCOUNTER)})
        ),
    MISSILE(
        602, "Misslie !", 2, 
        ...
        true,
        ActionX::DO_MISSILE,
        createLabelsContainer(new ActionLabel[]{L(CRIMINALS,2), L(CAN_BE_REMOVED), L(LONG_RANGE_ATTACKING), L(AIR_RAID)})
        ),
    //700 series healing
    HEALING(
        701,"Healing",1,
        ...
        true,
        ActionX::DO_HEALING,
        createLabelsContainer(new ActionLabel[]{L(CAN_BE_STOLEN)})
        ),
    ...
    MISSILE_LAUNCHER(
        ...
        createLabelsContainer(new ActionLabel[]{L(DEVICES), L(CRIMINALS,1), L(CAN_BE_REMOVED), L(MERCY)})
        ),
    MINE(
        802, "Mine", 2, 
        ...
        createLabelsContainer(new ActionLabel[]
            {L(DEVICES), L(CRIMINALS,1), L(CAN_BE_STOLEN), L(CAN_BE_REMOVED), L(MERCY), L(FROM_UNDERGOUND)})
        ),
    ...
    ENGINEER(
        ...
        true, 
        ActionX::DO_ENGNIEER,
        createLabelsContainer(new ActionLabel[]{L(SPECIALISTS), L(CRIMINALS,1), L(ENCOUNTER), L(MERCY)})
        );
    ...
    private final ActionLabelsContainer labelsContainer;
    ...
    private static final void DO_ADD_AMMO(RoundStats stats,Players applier, Players[] targets){
        switch(stats){
            case NONE,WIN:{
    ...
    private static final void DO_PISTAL_SHOOT(RoundStats stats, Players applier, Players[] targets){
        switch (stats) {
            case NONE:{
            ...
            case WIN:{
                ...
                targets[0].setHP(targets[0].getHP() - applier.getPlayerStats().rawDmg);
                break;
            }
        }
    }
    private static final void DO_DOUBLE_SHOOT(RoundStats stats, Players applier, Players[] targets){
        switch(stats){
            case NONE:{
    ...
    private static final void DO_DEF(RoundStats stats, Players applier, Players[] targets){
        switch(stats){
            case NONE:{
    ...
    private static final void DO_ABSLUTE_DEF(RoundStats stats, Players applier, Players[] targets){
        switch(stats){
            case NONE:{
    ...
    private static final void DO_THIEF(RoundStats stats, Players applier, Players[] targets){
        switch(stats){
            case NONE:{
    ...
    private static final void DO_ROUGE(RoundStats stats, Players applier, Players[] targets){
        switch(stats){
            case NONE:{
    ...
    private static final void DO_POLICE(RoundStats stats, Players applier, Players[] targets){
        applier.getPlayerStats().setPolice(true);
        switch(stats){
            case NONE:{
                applier.getPlayerStats()
                .basicApply(POLICE.toAction())
                .setPolice(true);
    ...
    private static final void DO_ARMED_POLICE(RoundStats stats, Players applier, Players[] targets){
        switch(stats){
            case NONE:{
                applier.getPlayerStats()
                .basicApply(ARMED_POLICE.toAction())
                .setPolice(true);;
    ...
    private static final void DO_RPG(RoundStats stats, Players applier, Players[] targets){
        switch(stats){
            case NONE:{
    ...
    private static final void DO_MISSILE(RoundStats stats, Players applier, Players[] targets){
        switch(stats){
            case NONE:{
    ...
    private static final void DO_HEALING(RoundStats stats, Players applier, Players[] targets){
        switch(stats){
            case NONE:{
                applier.getPlayerStats()
                .basicApply(HEALING.toAction())
                .setHealingFlag(true);
    ...
    private static final void DO_MISSILE_LAUNCHER(RoundStats stats, Players applier, Players[] targets){
        switch(stats){
            case NONE:{
    ...
    private static final void DO_MINE_PLANTING(RoundStats stats, Players applier, Players[] targets){
    ...
    private static final void DO_ENGNIEER(RoundStats stats, Players applier, Players[] targets){
        applier.getPlayerStats().setEngineer(true);
        switch(stats){
            case NONE:{
                applier.getPlayerStats()
                .basicApply(ENGINEER.toAction())
                .setEngineer(true);;
            ...
            case WIN,TIED:{
                if(targets[0].getPlayerStats().rawDef > 0){
